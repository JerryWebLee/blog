      ...
      <div class="bg-white p-6 rounded-lg shadow-md">
        ...
        <div class="space-y-2">
          ...
          <div class="flex justify-between">
            ...
            <span
              :class="
                config.env.isDevelopment ? 'text-green-600' : 'text-gray-400'
              "
            >
          ...
          <div class="flex justify-between">
            ...
            <span
              :class="
                config.env.isProduction ? 'text-red-600' : 'text-gray-400'
              "
            >
          ...
          <div class="flex justify-between">
            ...
            <span
              :class="config.env.isTest ? 'text-blue-600' : 'text-gray-400'"
            >
      ...
      <div class="bg-white p-6 rounded-lg shadow-md">
        ...
        <div class="space-y-2">
          <div class="flex justify-between">
            ...
            <span class="text-blue-600 font-mono text-sm">{{
              config.api.baseUrl
            }}</span>
          </div>
          <div class="flex justify-between">
      ...
      <div class="bg-white p-6 rounded-lg shadow-md">
        ...
        <div class="space-y-2">
          <div class="flex justify-between">
            ...
            <span
              :class="config.debug.enabled ? 'text-green-600' : 'text-red-600'"
            >
        ...
        <table class="min-w-full">
          ...
          <tbody>
            <tr v-for="(value, key) in envVars" :key="key" class="border-b">
              ...
              <td class="py-2 px-4 font-mono text-sm text-blue-600">
                {{ value }}
              </td>
